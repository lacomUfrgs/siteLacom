...
date: "2014-09-28"
linktitle: Criando um novo tema
menu:
  main:
    parent: Tutoriais
...
## Introdução
Este tutorial mostrará como criar um tema simples no Hugo. Suponho que você esteja familiarizado com HTML, a linha de comando do bash e que esteja confortável usando o Markdown para formatar o conteúdo. Vou explicar como Hugo usa modelos e como você pode organizá-los para criar um tema. Não abordarei o uso de CSS para estilizar seu tema.

Começaremos com a criação de um novo site com um modelo muito básico. Em seguida, adicionaremos algumas páginas e postagens. Com pequenas variações, você poderá criar muitos tipos diferentes de sites.

Neste tutorial, os comandos inseridos começarão com o prompt "$". A saída seguirá. As linhas que começam com "#" são comentários que adicionei para explicar um ponto. Quando mostro atualizações para um arquivo, o ": wq" na última linha significa salvar o arquivo.

...
{{< button status="danger" url="/gnuradio/introduction.pt_files/index.pdf" >}}danger{{< /button >}}

#### Button with Font Awesome

{{< button icon="fas fa-download" url="/gnuradio/introduction.pt_files/index.pdf" >}}Download{{< /button >}}

{{< button status="success" icon="fas fa-cloud-download-alt" url="/gnuradio/introduction.pt_files/index.pdf" >}}Download{{< /button >}}

{{< button status="success" icon="fas fa-file-pdf" url="/gnuradio/introduction.pt_files/index.pdf" >}}pdf{{< /button >}}

{{< button status="warning" icon="fa fa-file-word" url="/gnuradio/introduction.pt_files/index.pdf" >}}pdf{{< /button >}}

{{< button status="caution" icon="fa fa-file-archive" url="/gnuradio/introduction.pt_files/index.pdf" >}}tex{{< /button >}}
